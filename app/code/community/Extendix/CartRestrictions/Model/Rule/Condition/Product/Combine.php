...
class Extendix_CartRestrictions_Model_Rule_Condition_Product_Combine
    extends Mage_Rule_Model_Condition_Combine
{
    ...
    protected function _initializeProductAttributesInfo()
    {
        if (is_null($this->_productAttributesInfo)) {
            ...
            $productAttributes = Mage::getModel('extendix_cartrestrictions/rule_condition_product')
            ...
            foreach ($productAttributes as $attributeCode => $attributeLabel) {
                if ($this->_getIsQuoteItemAttribute($attributeCode)) {
                    $this->_addAttributeToConditionGroup(
                        ...
                        'extendix_cartrestrictions/rule_condition_product',
                        $attributeCode,
                        $attributeLabel
                    );
                } else {
                    $this->_addAttributeToConditionGroup(
                        ...
                        'extendix_cartrestrictions/rule_condition_product_attribute_assigned',
                        $attributeCode,
                        $attributeLabel
                    );
                }
    ...
    {
        parent::__construct();
        $this->setType('extendix_cartrestrictions/rule_condition_product_combine');
    }
        ...
        $conditions = array_merge_recursive(
            ...
            array(
                array(
                    ...
                    'value' => 'extendix_cartrestrictions/rule_condition_product_combine'
                ),
                array(
